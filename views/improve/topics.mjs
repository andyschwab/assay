...
// Feeds IMPROVE.md's "Requirements by topic" section (views/improve.yaml) and
// the axis walk's per-axis requirement lists + the custody, reproducibility and operability
// sections. Reads ONLY the yardstick's measurement (yardstick.yaml) plus the
// yardstick, for title/tier/topic — never findings directly.
//
...
export function toYaml(topics) {
  const L = ['# views/improve.yaml — GENERATED by views/improve/topics.mjs --write. Do not hand-edit.',
