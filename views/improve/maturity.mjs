...
//   node assay.mjs maturity <eval-dir> --write  # regenerate view-maturity-grades.yaml
...
export function gradesToYaml(g, generatedNote) {
  const out = [];
  out.push(`# view-maturity-grades.yaml — GENERATED by views/improve/maturity.mjs --write. Do not hand-edit:`);
