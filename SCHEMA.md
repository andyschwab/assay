...
│   ├── view-descriptors.yaml       # GENERATED by descriptors.mjs --write (compile-package runs it): the register read (registry/README.md); validate.mjs recomputes every status and fails on drift
