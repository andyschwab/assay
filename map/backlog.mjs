...
// ── emit ──
const header = `# backlog-computed.yaml — GENERATED by map/backlog.mjs. Do not hand-edit.\n` +
  ...
  `# Regenerate: node assay.mjs backlog ${runDir}${target ? ` --target ${target}` : ''}${prior ? ` --prior ${prior}` : ''} --write\n`;
